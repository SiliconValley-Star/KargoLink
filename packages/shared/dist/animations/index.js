...
exports.animationUtils = exports.keyframes = exports.animations = void 0;
exports.animations = {
    duration: {
        instant: '0ms',
        fast: '150ms',
...
exports.animationUtils = {
    injectKeyframes: () => {
        ...
        if (!document.getElementById(styleId)) {
            ...
            styleSheet.textContent = exports.keyframes;
            document.head.appendChild(styleSheet);
        }
    },
    transition: (properties, duration = 'normal', easing = 'easeOut') => {
        const props = Array.isArray(properties) ? properties.join(', ') : properties;
        return `${props} ${exports.animations.duration[duration]} ${exports.animations.easing[easing]}`;
    },
    combineAnimations: (...animationObjects) => {
